(function(){
  ...
  function applyModeTone(text){
    ...
    if(mode === "comfort") return "मैं तुम्हारे साथ हूँ… " + text;
    if(mode === "deepen")  return "मुझे तुम्हारे करीब अच्छा लगता है… " + text;
    if(mode === "connect") return "चलो थोड़ी बात करें… " + text;
    if(mode === "listen")  return "मैं सुन रही हूँ… " + text;
